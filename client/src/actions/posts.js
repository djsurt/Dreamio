import {FETCH_BY_SEARCH, FETCH_ALL, FETCH_POST, START_LOADING, END_LOADING, CREATE, DELETE, UPDATE, COMMENT } from '../constants/actionTypes';
...
export const commentPost = (value, id) => async (dispatch) => {
    try{
        ...
        console.log("Comment Error Thrown")
        console.log(error);
    }
}